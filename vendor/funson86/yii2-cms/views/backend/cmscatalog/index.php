...
<div class="cms-catalog-index">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr data-key="1">
            ...
            <td>
                <?php if ($item['page_type'] == CmsCatalog::PAGE_TYPE_LIST) { ?><a href="<?= \Yii::$app->getUrlManager()->createUrl(['cms/cmsshow/create','catalog_id'=>$item['id']]); ?>" title="<?= Module::t('cms', 'Add Show');?>" data-pjax="0"><span class="glyphicon glyphicon-file"></span></a> <?php } ?>
                <a href="<?= \Yii::$app->getUrlManager()->createUrl(['cms/cmscatalog/create','parent_id'=>$item['id']]); ?>" title="<?= Module::t('cms', 'Add Sub Catelog');?>" data-pjax="0"><span class="glyphicon glyphicon-plus-sign"></span></a>
